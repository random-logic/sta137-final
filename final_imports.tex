...
\pandocbounded{\includegraphics[keepaspectratio]{final_imports_files/figure-latex/unnamed-chunk-8-3.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{final_imports_files/figure-latex/unnamed-chunk-8-4.pdf}}
...
\CommentTok{\# Use stored lambda from earlier}
\NormalTok{inv\_forecast }\OtherTok{\textless{}{-}} \FunctionTok{inv\_boxcox}\NormalTok{(imports\_forecast}\SpecialCharTok{$}\NormalTok{mean, lambda)}
\NormalTok{inv\_lower }\OtherTok{\textless{}{-}} \FunctionTok{inv\_boxcox}\NormalTok{(imports\_forecast}\SpecialCharTok{$}\NormalTok{lower[, }\DecValTok{2}\NormalTok{], lambda)}
\NormalTok{inv\_upper }\OtherTok{\textless{}{-}} \FunctionTok{inv\_boxcox}\NormalTok{(imports\_forecast}\SpecialCharTok{$}\NormalTok{upper[, }\DecValTok{2}\NormalTok{], lambda)}

\CommentTok{\# Combine historical and forecast data}
\NormalTok{historical\_years }\OtherTok{\textless{}{-}} \FunctionTok{time}\NormalTok{(boxcox\_imports\_ts)}
\NormalTok{historical\_values }\OtherTok{\textless{}{-}} \FunctionTok{inv\_boxcox}\NormalTok{(boxcox\_imports\_ts, lambda)}
\NormalTok{df\_history }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}
  \AttributeTok{Year =}\NormalTok{ historical\_years,}
  \AttributeTok{Imports =}\NormalTok{ historical\_values}
\NormalTok{)}

\NormalTok{forecast\_years }\OtherTok{\textless{}{-}} \FunctionTok{time}\NormalTok{(imports\_forecast}\SpecialCharTok{$}\NormalTok{mean)}
...
\FunctionTok{ggplot}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{geom\_line}\NormalTok{(}\AttributeTok{data =}\NormalTok{ df\_history, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ Year, }\AttributeTok{y =}\NormalTok{ Imports), }\AttributeTok{color =} \StringTok{"black"}\NormalTok{) }\SpecialCharTok{+}
  ...
  \FunctionTok{ggtitle}\NormalTok{(}\StringTok{"ARIMA Forecast of Imports"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{xlab}\NormalTok{(}\StringTok{"Year"}\NormalTok{) }\SpecialCharTok{+} \FunctionTok{ylab}\NormalTok{(}\StringTok{"Imports $"}\NormalTok{) }\SpecialCharTok{+}
...
\pandocbounded{\includegraphics[keepaspectratio]{final_imports_files/figure-latex/unnamed-chunk-10-1.pdf}}
